...
module.exports = function (passport, user) {
  ...
  passport.use('local-signup', new LocalStrategy(
    ...
    {
      usernameField: 'userName',  // this property was called email but had to be changed to usernameField to use the email as a login
    ...
    function (req, userName, password, done) {
      ...
      User.findOne({ where: { userName: userName } }).then(function (user) {
        ...
        if (user) {
          console.log("passport.js, Hey there is ALREADY ANOTHER USER WITH THAT username!")
  ...
  passport.use('local-signin', new LocalStrategy(

    {
      ...
      usernameField: 'userName', // changed from emailField to usernameField... had to do it for signup... probabbly need to here too
      passwordField: 'password',
      passReqToCallback: true // allows us to pass back the entire request to the callback
    },
    ...
    function (req, userName, password, done) {
      ...
      User.findOne({ where: { userName: userName } }).then(function (user) {
        ...
        if (!user) {
          console.log("passport.js, There is NO SUCH USER (userName)!") // Not sure this is working
